...
.password-wrapper input[type="password"].has-text ~ .eye-icon {
    ...
    .caps-lock-warning {
    position: absolute;
    top: 75%; /* Place it below the input field */
    left: 0;
    color: red;
    font-size: 15px;
    margin-top: 5px;
...
function togglePasswordVisibility(event) {
    ...
    <body>
        ...
        <div class="form-column">
            ...
            <input type="text" id="first_name" name="first_name" value="<?php echo htmlspecialchars($first_name); ?>" required pattern="^[a-zA-Z]+(?:\s[a-zA-Z]+)*$" title="First name must not start or end with a space and can only contain letters and single spaces between words." oninput="validateFirstName()">
    <div id="first-name-error" style="color: red; display: none;">First name must not start or end with a space and can only contain letters and single spaces between words.</div>
    </div>
    <div class="form-column">
                        <label for="middle_name">Middle Name: (Optional)</label>
                        <input type="text" id="middle_name" name="middle_name" value="<?php echo htmlspecialchars($middle_name); ?>" pattern="^[a-zA-Z]+(?:\s[a-zA-Z]+)*$" title="Middle name must not start or end with a space and can only contain letters and single spaces between words." oninput="validateMiddleName()">
                        <div id="middle-name-error" style="color: red; display: none;">Middle name must not start or end with a space and can only contain letters and single spaces between words.</div>
                    </div>
                </div>
    <div class="form-row">
        <div class="form-column">
            <label for="last_name">Last Name:</label>
            <input type="text" id="last_name" name="last_name" value="<?php echo htmlspecialchars($middle_name); ?>" required pattern="^[a-zA-Z]+(?:\s[a-zA-Z]+)*$" title="Last name must not start or end with a space and can only contain letters and single spaces between words." oninput="validateLastName()">
    <div id="last-name-error" style="color: red; display: none;">Last name must not start or end with a space and can only contain letters and single spaces between words.</div>
    </div>
        <div class="form-column">
    ...
    <div class="form-row">
        <div class="form-column">
            ...
            <div id="age-error" style="color: red; display: none;">You must be at least 13 years old to register.</div>
        </div>
    ...
    if (lastNameValue.length < 2 || !lastNamePattern.test(lastNameValue)) {
        ...
        function validateAge() {
            ...
            if (age < 13) {
                ...
                birthdateInput.setCustomValidity('You must be at least 13 years old.');
            } else {
