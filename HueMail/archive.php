...
// Define folder as 'archive'
$folder = 'archive';

// Get folder from query string or default to 'archive'
$folder = isset($_GET['folder']) ? $_GET['folder'] : 'archive';
...
<head>
    ...
    <style>
        ...
        .main-content {
            margin-left: 270px; /* Adjust based on the width of the side panel */
            padding: 20px;
            flex: 1;
        ...
        .navbar .profile img { /* Profile picture styling */
            ...
            margin-right: 10px;
            cursor: pointer;
            border: 3px solid #1a73e8; /* Border color and width */
        }
...
.fas {
    margin-right: 5px;
        ...
        .search-container {
            position: relative;
            width: 60%; /* Adjusted width to make it slightly larger */
        ...
        .search-container input {
            ...
            border: 2px solid #ddd; /* Thinner border for a more modern look */
